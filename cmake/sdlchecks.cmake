macro(CheckDLOPEN)
  ...
  if (HAVE_DLOPEN)
    ...
    file(GLOB DLOPEN_SOURCES ${SDL_SOURCE_DIR}/src/loadso/dlopen/*.c)
...
macro(CheckOSS)
  if(OSS)
    ...
    if(OSS_FOUND)
      set(HAVE_OSS TRUE)
      file(GLOB OSS_SOURCES ${SDL_SOURCE_DIR}/src/audio/dma/*.c ${SDL_SOURCE_DIR}/src/audio/dsp/*.c)
...
macro(CheckALSA)
  if(ALSA)
    ...
    if(HAVE_ASOUNDLIB_H)
      ...
      set(HAVE_ALSA TRUE)
      file(GLOB ALSA_SOURCES ${SDL_SOURCE_DIR}/src/audio/alsa/*.c)
...
macro(CheckPulseAudio)
  if(PULSEAUDIO)
    ...
    if(PKG_PULSEAUDIO_FOUND)
      ...
      file(GLOB PULSEAUDIO_SOURCES ${SDL_SOURCE_DIR}/src/audio/pulseaudio/*.c)
...
macro(CheckESD)
  if(ESD)
    ...
    if(PKG_ESD_FOUND)
      set(HAVE_ESD TRUE)
      file(GLOB ESD_SOURCES ${SDL_SOURCE_DIR}/src/audio/esd/*.c)
...
macro(CheckARTS)
  if(ARTS)
    ...
    if(ARTS_CONFIG)
      ...
      file(GLOB ARTS_SOURCES ${SDL_SOURCE_DIR}/src/audio/arts/*.c)
...
macro(CheckNAS)
  if(NAS)
    ...
    if(HAVE_NAS_H AND D_NAS_LIB)
      set(HAVE_NAS TRUE)
      file(GLOB NAS_SOURCES ${SDL_SOURCE_DIR}/src/audio/nas/*.c)
...
macro(CheckFusionSound)
  if(FUSIONSOUND)
    ...
    if(PKG_FUSIONSOUND_FOUND)
      ...
      file(GLOB FUSIONSOUND_SOURCES ${SDL_SOURCE_DIR}/src/audio/fusionsound/*.c)
...
macro(CheckX11)
  if(VIDEO_X11)
    ...
    if(X11_LIB)
      ...
      file(GLOB X11_SOURCES ${SDL_SOURCE_DIR}/src/video/x11/*.c)
      ...
      if(VIDEO_X11_XINERAMA AND HAVE_XINERAMA_H)
        ...
        file(GLOB_RECURSE XINERAMA_SOURCES ${SDL_SOURCE_DIR}/src/video/Xext/*.c)
        set(SOURCE_FILES ${SOURCE_FILES} ${XINERAMA_SOURCES})
...
macro(CheckCOCOA)
  if(VIDEO_COCOA)
    ...
    if(HAVE_VIDEO_COCOA)
      file(GLOB COCOA_SOURCES ${SDL_SOURCE_DIR}/src/video/cocoa/*.m)
...
macro(CheckDirectFB)
  if(VIDEO_DIRECTFB)
    ...
    if(PKG_DIRECTFB_FOUND)
      ...
      file(GLOB DIRECTFB_SOURCES ${SDL_SOURCE_DIR}/src/video/directfb/*.c)
  ...
  if(PTHREADS)
    ...
    if(HAVE_PTHREADS)
      ...
      set(SOURCE_FILES ${SOURCE_FILES}
          ${SDL_SOURCE_DIR}/src/thread/pthread/SDL_systhread.c
          ${SDL_SOURCE_DIR}/src/thread/pthread/SDL_sysmutex.c   # Can be faked, if necessary
          ${SDL_SOURCE_DIR}/src/thread/pthread/SDL_syscond.c    # Can be faked, if necessary
          )
      if(HAVE_PTHREADS_SEM)
        set(SOURCE_FILES ${SOURCE_FILES}
            ${SDL_SOURCE_DIR}/src/thread/pthread/SDL_syssem.c)
      else(HAVE_PTHREADS_SEM)
        set(SOURCE_FILES ${SOURCE_FILES}
            ${SDL_SOURCE_DIR}/src/thread/generic/SDL_syssem.c)
      endif(HAVE_PTHREADS_SEM)
...
macro(CheckUSBHID)
  ...
  if(HAVE_USBHID)
    ...
    file(GLOB BSD_JOYSTICK_SOURCES ${SDL_SOURCE_DIR}/src/joystick/bsd/*.c)
